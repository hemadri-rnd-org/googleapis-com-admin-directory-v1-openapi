...
func Directory_groups_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_groups_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_admin_directory_v1_groups_groupKey",
		mcp.WithDescription("Deletes a group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_groups_deleteHandler(cfg),
	}
}
