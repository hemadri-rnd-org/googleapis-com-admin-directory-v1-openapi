...
func Directory_groups_aliases_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_groups_aliases_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_directory_v1_groups_groupKey_aliases",
		mcp.WithDescription("Lists all aliases for a group."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_groups_aliases_listHandler(cfg),
	}
}
