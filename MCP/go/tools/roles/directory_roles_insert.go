...
func Directory_roles_insertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_roles_insertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_admin_directory_v1_customer_customer_roles",
		mcp.WithDescription("Creates a role."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_roles_insertHandler(cfg),
	}
}
