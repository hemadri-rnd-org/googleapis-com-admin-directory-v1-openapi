...
func Directory_roles_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_roles_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_admin_directory_v1_customer_customer_roles_roleId",
		mcp.WithDescription("Deletes a role."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_roles_deleteHandler(cfg),
	}
}
