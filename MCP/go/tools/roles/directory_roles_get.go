...
func Directory_roles_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_roles_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_directory_v1_customer_customer_roles_roleId",
		mcp.WithDescription("Retrieves a role."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_roles_getHandler(cfg),
	}
}
