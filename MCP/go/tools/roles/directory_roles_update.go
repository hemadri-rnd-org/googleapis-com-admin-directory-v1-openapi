...
func Directory_roles_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_roles_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_admin_directory_v1_customer_customer_roles_roleId",
		mcp.WithDescription("Updates a role."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_roles_updateHandler(cfg),
	}
}
