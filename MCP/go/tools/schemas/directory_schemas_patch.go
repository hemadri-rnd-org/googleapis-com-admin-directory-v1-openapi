...
func Directory_schemas_patchHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_schemas_patchTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_admin_directory_v1_customer_customerId_schemas_schemaKey",
		mcp.WithDescription("Patches a schema."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_schemas_patchHandler(cfg),
	}
}
