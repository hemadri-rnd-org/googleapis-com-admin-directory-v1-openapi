...
func Directory_schemas_insertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_schemas_insertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_admin_directory_v1_customer_customerId_schemas",
		mcp.WithDescription("Creates a schema."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_schemas_insertHandler(cfg),
	}
}
