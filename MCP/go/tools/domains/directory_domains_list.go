...
func Directory_domains_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_domains_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_directory_v1_customer_customer_domains",
		mcp.WithDescription("Lists the domains of the customer."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_domains_listHandler(cfg),
	}
}
