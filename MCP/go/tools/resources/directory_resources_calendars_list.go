...
func Directory_resources_calendars_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.CalendarResources
...
func CreateDirectory_resources_calendars_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_admin_directory_v1_customer_customer_resources_calendars",
		mcp.WithDescription("Retrieves a list of calendar resources for an account."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_resources_calendars_listHandler(cfg),
	}
}
