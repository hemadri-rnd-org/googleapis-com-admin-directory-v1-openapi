...
func Directory_resources_features_insertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_resources_features_insertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_admin_directory_v1_customer_customer_resources_features",
		mcp.WithDescription("Inserts a feature."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_resources_features_insertHandler(cfg),
	}
}
