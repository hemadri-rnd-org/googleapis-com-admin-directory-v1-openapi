...
func Directory_resources_buildings_insertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_resources_buildings_insertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_admin_directory_v1_customer_customer_resources_buildings",
		mcp.WithDescription("Inserts a building."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_resources_buildings_insertHandler(cfg),
	}
}
