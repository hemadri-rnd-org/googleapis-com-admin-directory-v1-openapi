...
func Directory_customers_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_customers_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_admin_directory_v1_customers_customerKey",
		mcp.WithDescription("Updates a customer."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_customers_updateHandler(cfg),
	}
}
