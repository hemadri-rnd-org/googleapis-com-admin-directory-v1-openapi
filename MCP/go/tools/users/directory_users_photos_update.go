...
func Directory_users_photos_updateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_users_photos_updateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_admin_directory_v1_users_userKey_photos_thumbnail",
		mcp.WithDescription("Adds a photo for the user."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_users_photos_updateHandler(cfg),
	}
}
