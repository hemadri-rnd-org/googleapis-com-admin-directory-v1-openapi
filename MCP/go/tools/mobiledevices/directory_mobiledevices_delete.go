...
func Directory_mobiledevices_deleteHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDirectory_mobiledevices_deleteTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_admin_directory_v1_customer_customerId_devices_mobile_resourceId",
		mcp.WithDescription("Removes a mobile device."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Directory_mobiledevices_deleteHandler(cfg),
	}
}
