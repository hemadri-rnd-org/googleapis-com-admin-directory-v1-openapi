# Admin SDK API MCP Server

This MCP (Model Content Protocol) server provides access to Admin SDK API API functionality through HTTP, HTTPS, and STDIO transport modes.
